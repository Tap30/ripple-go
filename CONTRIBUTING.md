...
[Code of Conduct](https://github.com/Tap30/ripple-go/blob/main/CODE_OF_CONDUCT.md).
...
[good first issues](https://github.com/Tap30/ripple-go/issues?q=is:open+is:issue+label:"good+first+issue")
...
[good to take issues](https://github.com/Tap30/ripple-go/issues?q=is:open+is:issue+label:"good+to+take").
...
2. Clone the fork to your local machine and add upstream remote:
   ...
   ```sh
   git clone https://github.com/<your username>/ripple-go.git
   cd ripple-go
   git remote add upstream https://github.com/Tap30/ripple-go.git
   ```
...
7. Go to [the repository](https://github.com/Tap30/ripple-go) and make a Pull
   Request.
...
[Onboarding Documentation](https://github.com/Tap30/ripple-go/blob/main/ONBOARDING.md).
